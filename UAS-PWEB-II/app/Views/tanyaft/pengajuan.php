...
<body>
    ...
    <nav class="sidebar p-3" style="margin-top: 74px; width:max-content;">
        ...
        <div class="card content flex-grow-1 p-3" style="margin-left: 320px; margin-right:40px; width:auto; margin-top:100px; box-shadow: 4px 4px 4px 4px rgba(0, 0, 0, 0.1);">
            ...
            <?php endif; ?>
                <form action="<?= base_url('/pengajuan/submit') ?>" method="post" enctype="multipart/form-data" class="d-flex flex-column">
                    ...
                    <textarea class="form-control mb-4" name="pertanyaan" rows="7" placeholder="Masukkan pertanyaan" required></textarea>
                    <div class="container p-0">
                        ...
                        <div class="file-input-wrapper">
                            ...
                            <label class="file-label" for="fileInput" id="fileName">Drag and drop a file here or click</label>
                            <input type="file" name="berkas_pendukung" id="fileInput" accept=".jpg,.jpeg,.png" onchange="updateFileName()" required>
                        </div>
                    </div>
                    <span class="text-secondary" style="font-size:12px; font-style:italic;">* Berkas harus dalam format jpg, png, jpeg, maksimal 2MB</span>
                    <div class="ms-auto mt-5">
                        <button type="reset" class="btn p-2" style="width: 150px; border:1px solid black;">
                            Batal
                        </button>
                        <button type="submit" class="btn p-2" style="width: 150px; background-color:deepskyblue; color:white;"> 
                            Kirim
                        </button>
                    </div>
                </form>
    ...
    <script>
        function updateFileName() {
            ...
            fileNameLabel.textContent = input.files.length > 0 ? input.files[0].name : 'Drag and drop a file here or click';
        }
    </script>
</body>
</html>
