        ...
        <div class="card content flex-grow-1 p-3" style="margin-left: 320px; margin-right:40px; width:auto; margin-top:100px; box-shadow: 4px 4px 4px 4px rgba(0, 0, 0, 0.1);">
            ...
            <section class="d-flex flex-column">
                <div class="d-flex flex-row" >
                    <div class="d-flex flex-column" style="flex: 1; margin-right:20px;">
                    <label class="fw-bold" for="nama">ID Pengajuan</label> 
                    <input class="form-control mb-4 w-100" style="background-color: #e9ecef; padding:15px; width:auto" type="text" name="nim" placeholder="" value="<?=$pengajuan["id"]?>" disabled>
                    </div>
                    <div class="d-flex flex-column" style=" margin-right:420px;">
                    <label class="fw-bold" for="nama">Status Pengajuan</label> 
                    <p class="approved-button">Disetujui</p>
                    </div> 
                </div>
                <div class="d-flex flex-row">
                    <div class="d-flex flex-column" style="flex: 1; margin-right:20px;">
                    <label class="fw-bold" for="nama">Tanggal Pengajuan</label> 
                    <input class="form-control mb-4 w-100" style="background-color: #e9ecef; padding:15px; width:auto" type="text" name="nim" placeholder="" value="<?=$pengajuan["created_at"]?>" disabled>
                    </div>
                    <div class="d-flex flex-column" style="flex: 1; margin-right:20px;">
                    <label class="fw-bold" for="nama">Nama Lengkap</label> 
                    <input class="form-control mb-4 w-100" style="background-color: #e9ecef; padding:15px; width:auto" type="text" name="nim" placeholder="" value="<?=$pengajuan["nama"]?>" disabled>
                    </div>
                </div>
                <div class="d-flex flex-row">
                    <div class="d-flex flex-column" style="flex: 1; margin-right:20px;">
                    <label class="fw-bold" for="nama">NIM</label> 
                    <input class="form-control mb-4 w-100" style="background-color: #e9ecef; padding:15px; width:auto" type="text" name="nim" placeholder="" value="2210817110001" disabled>
                    </div>
                    <div class="d-flex flex-column" style="flex: 1; margin-right:20px;">
                    <label class="fw-bold" for="nama">Program Studi</label> 
                    <input class="form-control mb-4 w-100" style="background-color: #e9ecef; padding:15px; width:auto" type="text" name="nim" placeholder="" value="Teknologi Informasi" disabled>
                    </div>
                </div>
                <div class="d-flex flex-row">
                    <div class="d-flex flex-column" style="flex: 1; margin-right:20px;">
                    <label class="fw-bold" for="nama">Pertanyaan</label> 
                    <input class="form-control mb-4 w-100" style="background-color: #e9ecef; padding:15px; width:auto" type="text" name="nim" placeholder="" value="<?=$pengajuan["pertanyaan"]?>" disabled>
                    </div>
                    <div class="d-flex flex-column" style="flex: 1; margin-right:20px;">
                    <label class="fw-bold" for="nama">Berkas Pendukung</label> 
